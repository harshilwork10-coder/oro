...
CREATE TABLE "new_Franchisor" (
    ...
    "baseRate" DECIMAL NOT NULL DEFAULT 99.00,
...
INSERT INTO "new_Franchisor" ("billingMethod", "createdAt", "deletedAt", "id", "name", "ownerId", "salesAgentId", "supportFee", "type", "updatedAt") SELECT "billingMethod", "createdAt", "deletedAt", "id", "name", "ownerId", "salesAgentId", "supportFee", "type", "updatedAt" FROM "Franchisor";
