        ...
        <div>
            ...
            <div className="mb-6 p-4 bg-amber-500/10 border border-amber-500/30 rounded-xl flex items-center gap-3">
                ...
                <div>
                    ...
                    <p className="text-amber-400/70 text-xs">All monitoring values are static placeholders. Real device and payment health data will be connected in a future release.</p>
                </div>
            </div>
