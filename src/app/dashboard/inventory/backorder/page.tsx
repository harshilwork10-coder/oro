    ...
    return (
        <div className="min-h-screen bg-stone-950 flex items-center justify-center p-6">
            <div className="text-center max-w-md">
                ...
                <h1 className="text-2xl font-bold text-white mb-2">Backorder Tracking</h1>
                <p className="text-stone-400 mb-6">
                    This feature is coming soon. Backorder management will be available in a future update.
                </p>
