        ...
        <div className="p-8 max-w-7xl mx-auto">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-stone-500 mt-1">Overview of your franchise sales pipeline</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
                    ...
                    <p className="text-stone-500 text-sm font-medium">Total Leads</p>
                    <h3 className="text-2xl font-bold text-stone-900">{stats.totalLeads}</h3>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
                    ...
                    <p className="text-stone-500 text-sm font-medium">Pipeline Value</p>
                    <h3 className="text-2xl font-bold text-stone-900">${stats.pipelineValue.toLocaleString()}</h3>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
                    ...
                    <p className="text-stone-500 text-sm font-medium">Conversion Rate</p>
                    <h3 className="text-2xl font-bold text-stone-900">{stats.conversionRate}%</h3>
                </div>
                ...
                <div className="bg-white p-6 rounded-2xl border border-stone-200 shadow-sm">
                    ...
                    <p className="text-stone-500 text-sm font-medium">Territories Sold</p>
                    <h3 className="text-2xl font-bold text-stone-900">{stats.activeTerritories}</h3>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
                    <div className="p-6 border-b border-stone-100 flex items-center justify-between">
                        <h2 className="text-lg font-bold text-stone-900">Recent Leads</h2>
                        <Link href="/dashboard/crm/leads" className="text-sm text-purple-600 hover:text-purple-700 font-medium">View All</Link>
                    </div>
                    <div className="divide-y divide-stone-100">
                        {recentLeads.map((lead) => (
                            <div key={lead.id} className="p-4 hover:bg-stone-50 transition-colors flex items-center justify-between">
                                ...
                                <div className="flex items-center gap-6">
                                    <div className="text-right">
                                        <p className="font-medium text-stone-900">${lead.value.toLocaleString()}</p>
                                        <p className="text-xs text-stone-500">{lead.date}</p>
                                    </div>
                ...
                <div className="bg-white rounded-2xl border border-stone-200 shadow-sm overflow-hidden">
                    ...
                    <div className="p-6 space-y-6">
                        <div className="flex gap-4">
                            ...
                            <div>
                                <p className="text-sm text-stone-900"><span className="font-bold">Call with John Smith</span> regarding franchise fees.</p>
                        ...
                        <div className="flex gap-4">
                            ...
                            <div>
                                <p className="text-sm text-stone-900"><span className="font-bold">Sent Proposal</span> to Sarah Jones.</p>
                                <p className="text-xs text-stone-500 mt-1">5 hours ago</p>
                            </div>
                        </div>
                        <div className="flex gap-4">
                            ...
                            <div>
                                <p className="text-sm text-stone-900"><span className="font-bold">Deposit Received</span> from Mike Brown.</p>
                                <p className="text-xs text-stone-500 mt-1">Yesterday</p>
                            </div>
                        </div>
                    </div>
                </div>
