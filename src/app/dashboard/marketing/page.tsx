...
import { Mail, Plus, BarChart2, Users, LayoutTemplate, Sparkles, Megaphone } from 'lucide-react'
import AIMessageComposer from '@/components/marketing/AIMessageComposer'
...
type TabType = 'campaigns' | 'ai-composer'
...
export default function MarketingPage() {
    ...
    const [activeTab, setActiveTab] = useState<TabType>('ai-composer')
            ...
            <div className="p-8 max-w-7xl mx-auto">
                ...
                <div className="flex gap-2 mb-6 border-b border-stone-800">
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-3 font-medium transition-colors border-b-2 -mb-px ${activeTab === 'ai-composer'
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-4 py-3 font-medium transition-colors border-b-2 -mb-px ${activeTab === 'campaigns'
                            ? 'text-orange-400 border-orange-400'
                            : 'text-stone-400 border-transparent hover:text-stone-300'
                            }`}
                    >
                ...
                {activeTab === 'ai-composer' ? (
                    <div className="bg-white/5 border border-white/10 rounded-2xl p-6">
                        <AIMessageComposer businessName="Oronex Spa" />
                    </div>
                ) : (
                    <>
                        {/* Quick Actions */}
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            <button className="bg-white/5 border border-white/10 rounded-2xl p-6 hover:bg-white/10 transition-colors text-left group">
                                <div className="p-3 bg-orange-500/20 rounded-xl w-fit mb-4 group-hover:scale-110 transition-transform">
                                    <LayoutTemplate className="h-6 w-6 text-orange-400" />
                                </div>
