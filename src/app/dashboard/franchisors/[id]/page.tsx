            ...
            <div className="glass-panel p-6 rounded-2xl">
                ...
                <div className="bg-violet-500/10 border border-violet-500/20 rounded-xl p-4">
                    <p className="text-violet-300 text-sm mb-3">
                        Oro Pulse gives owners real-time mobile access to sales, inventory, and employee data.
                    </p>
                    <a
                    ...
                    {client.franchises.map((location) => (
                        <div key={location.id} className="p-4 bg-stone-800/30 rounded-xl border border-stone-700 hover:border-purple-500/30 transition-all">
                            ...
                            <div className="flex flex-wrap gap-2 pt-3 border-t border-stone-700/50">
                                ...
                                <a
                                    href={`/dashboard/pos/stations?franchiseId=${location.id}`}
                                ...
                                <a
                                    href={`/dashboard/categories?franchiseId=${location.id}`}
                                ...
                                <a
                                    href={`/dashboard/settings?franchiseId=${location.id}`}
