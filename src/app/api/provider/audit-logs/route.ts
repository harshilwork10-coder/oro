...
// GET - Fetch audit logs (provider-scoped wrapper)
export async function GET(req: NextRequest) {
    try {
        ...
        if (franchiseId && franchiseId !== 'ALL') {
            where.changes = { contains: franchiseId }
        }
        ...
        console.error('[PROVIDER_AUDIT_LOGS_GET]', error)
...
export async function POST(req: NextRequest) {
    try {
        ...
        console.error('[PROVIDER_AUDIT_LOGS_POST]', error)
