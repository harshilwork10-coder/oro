                        ...
                        {step === 'waiver' && (
                            <div className="space-y-8 animate-in fade-in slide-in-from-right duration-300">
                                ...
                                <div className="bg-gray-50 p-4 rounded-xl text-xs text-gray-500 h-32 overflow-y-auto border border-gray-200">
                                    <p className="mb-2"><strong>Liability Waiver:</strong> By checking the box below, I acknowledge that I have received the services requested and am satisfied with the results. I release Oro and its employees from any liability regarding...</p>
                                    <p>I also consent to the use of my contact information for future appointment reminders and promotional offers from Oro.</p>
                                </div>
